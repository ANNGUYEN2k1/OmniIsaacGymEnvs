...
from omniisaacgymenvs.robots.articulations.views.tomodj_newhand_view import TomoDJView
...
class TomoDJnewhandCabinetTask(RLTask):
    ...
    def get_tomodj(self):
        tomodj = TomoDJ(prim_path=self.default_zero_env_path + "/tomodj", 
                          name="tomodj", 
                          usd_path=data_folder_path + '/TomoDJ/newhand/tomodj_instanceable.usd')
